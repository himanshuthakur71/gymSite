...
<div
	class="relative w-full border-b-[20px] border-primary bg-[url(/images/i-WQmMjBX-X3-1600x695.jpg)] bg-cover bg-center bg-no-repeat before:absolute before:block before:h-[170px] before:w-full before:bg-[rgba(0,0,0,0.6)]"
>
	<Header />
